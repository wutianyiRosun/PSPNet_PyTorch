...
class PSPModule(nn.Module):
    ...
    def __init__(self, inChannel, midReduction=4, outChannel=512, sizes=(1, 2, 3, 6)):
        ...
        self.bottleneck = nn.Conv2d( (inChannel+ self.midChannel*4), outChannel, kernel_size=1)  #512 1x1Conv
    ...
    def forward(self, feats):
        ...
        out = self.bottleneck(torch.cat(mulBranches, 1))
        out = self.bn(out)
        out = self.prelu(out)
        return out
